...
.content[
$$\text{PVE}_k = \sum_{m=1}^k\frac{V_m}{TV}$$
]
...
library(kableExtra)
library(knitr)
track_pca_smry <- tibble(evl=track_pca$sdev) %>%
...
Increase in variance explained large until $k=3$ PCs, and then tapers off. A choice of .orange[3 PCs] would explain 80% of the total variance. 
]]
